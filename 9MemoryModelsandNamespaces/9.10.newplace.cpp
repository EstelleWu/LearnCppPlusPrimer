...
int main()
{
    ...
    cout << "Memory addresses:\n" << "  heap: " << pd1
         << "  static: " << (void *) buffer << endl; // Q: otherwise, would print out string other than address
    cout << "Memory contnets:\n";
    ...
    delete [] pd1;
    pd1 = new double[N];           
    pd2 = new (buffer + N * sizeof(double)) double[N]; // don't overlap, follow pd4
    for (i = 0; i < N; i++)
    {
